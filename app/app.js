...
const passwordResetsController = require('./controllers/password_resets_controller')
const micropostsController = require('./controllers/microposts_controller')
const relationshipsController = require('./controllers/relationships_controller')
...
app.use('/password_resets', passwordResetsController.router)
app.use('/microposts', micropostsController.router)
app.use('/relationships', relationshipsController.router)
